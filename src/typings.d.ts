...
// cover only the APIs that the Neopilot codebase relies on. If full type
...
declare module "shell-quote" {
  ...
  // type definitions. We recreate the few that Neopilot‑Lib imports so that the
   ...
   * plain string is sufficient for type‑checking the Neopilot codebase while
   ...
   * redirection …) which we deliberately omit here because Neopilot never
   * inspects them.
   */

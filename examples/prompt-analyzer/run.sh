...
# run.sh — Create a new run_N directory for a Neopilot task, optionally bootstrapped from a template,
# then launch Neopilot with the task description from task.yaml.
#
# Usage:

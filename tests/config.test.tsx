...
test("loads user instructions + project doc when neopilot.md is present", () => {
  // 1) seed memfs: a config JSON, an instructions.md, and a neopilot.md in the cwd
  ...
  // and now our fake neopilot.md in the cwd:
  const neopilotPath = join(testDir, "neopilot.md");
  memfs[neopilotPath] = projectDoc;
